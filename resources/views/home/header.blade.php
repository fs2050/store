<header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="{{url('/')}}"><img width="210" src="{{asset('images/x5.jpg')}}" alt="#" /></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                        ...
                        padding-right: 10px!important">
                           <a class="nav-link"  style="background-color: lavender; " href="{{url('show_order')}}">Pedidos [ <span style="color: green;">{{App\Models\Order::where('user_id','=',Auth::user()->id)->count()}} ]</span></a>
                        </li>
                        ...
                        @else
                         ...
                         <li class="nav-item" style="padding-left: 10px!important;
                        padding-right: 10px!important">
                           <a class="nav-link"  style="background-color: lavender; " href="{{url('show_order')}}">Pedidos [ 0 ]</a>
                        </li>
