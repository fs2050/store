...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == '1') {
                ...
                $total_processing = order::where('delivery_status', '=', 'processabdo')->get()->count();
        ...
        if (Auth::id()) {
            ...
            if ($product_exist_id) {
                ...
                if ($product->discount_price != null) {
                    $cart->price = ($product->price - $product->discount_price) * $cart->quantity;
                } else {
                ...
                Alert::success('Produto adicionado ao carrinho', 'Produto Adiconado com Sucesso!');
    ...
    public function show_cart(Request $request)
    {
        ...
        if (Auth::id()) {
            ...
            $p = cart::where('product_id', '=', $id)->get();
            ...
            return view('home.showcart', compact('cart', 'cart_count', 'p'));
        } else {
            return redirect('login');
        }
    }
    ...
    public function cash_order($totalproduct)
    {
        ...
        if (Auth::id()) {
            ...
            if ($totalproduct == 0) {
                Alert::warning('Nenhum produto no carrinho', 'Por favor, adicione algum produto ao carrinho');
                ...
                foreach ($data as $data) {
                    ...
                    $order->payment_status = 'Pagamento na entrega';
                ...
                Alert::success('Obrigado pelo seu pedido', ' Logo entraremos em contato...');
    ...
    public function stripePost(Request $request, $totalprice)
    {
        ...
        if (Auth::id()) {
            ...
            Stripe\Charge::create([
                ...
                "description" => "Obrigado pelo pagamento!"
            ]);
            ...
            Alert::Success('Pagamento efetuado com sucesso!', 'Obrigado pelo pedido. Enviaremos a sua compra dentro de 48 horas.');
    ...
    public function cancel_order($id)
    {
        ...
        if (Auth::id()) {
            ...
            $order->delivery_status = 'Você cancelou o pedido';


            $order->save();

            Alert::warning('Pedido cancelado', 'Você cancelou seu pedido');
